...
class PublicRecipeApiTests(TestCase):
    ...
    def setUp(self):
        """Set up function for PublicRecipeApiTests class."""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        """Set up function for PrivateRecipeApiTests class."""
        self.client = APIClient()
...
class RecipeImageUploadTests(TestCase):
    """Test class for uploading images."""

    def setUp(self):
        """Set up function for RecipeImageUploadTests."""
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            'test@gmail.com',
            'test123'
    ...
    def tearDown(self):
        """Function to remove all test files."""
